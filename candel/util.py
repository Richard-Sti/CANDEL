...
def name2label(name):
    ...
    latex_labels = {
        ...
        "Omega0": r"$\Omega_0~[\mathrm{deg}]$",
        "dOmega_dr": r"$\mathrm{d}\Omega/\mathrm{d}r~[\mathrm{deg/mas}]$",
        "x0": r"$x_0~[\mu\mathrm{as}]$",
        "y0": r"$y_0~[\mu\mathrm{as}]$",
        "dv_sys": r"$\Delta v_{\rm sys}~[\mathrm{km/s}]$",
        "sigma_x_floor": r"$\sigma_{x,\mathrm{fl}}~[\mu\mathrm{as}]$",
        "sigma_y_floor": r"$\sigma_{y,\mathrm{fl}}~[\mu\mathrm{as}]$",
        "sigma_v_sys": r"$\sigma_{v,\mathrm{sys}}~[\mathrm{km/s}]$",
        "sigma_v_hv": r"$\sigma_{v,\mathrm{hv}}~[\mathrm{km/s}]$",
        "sigma_a_floor_sys": r"$\sigma_{a,\mathrm{sys}}$",
        "sigma_a_floor_hv": r"$\sigma_{a,\mathrm{hv}}$",
