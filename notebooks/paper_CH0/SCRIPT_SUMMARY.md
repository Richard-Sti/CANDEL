...
- `summarise_imb_geometric_reconstruction_effects.py`: reads `tasks_CH0_imb_geometric.txt`, summarises no-reconstruction, Carrick2015, and Manticore/COLA PCS posterior shifts in CPLR parameters and Cepheid-host distances, and records evidence availability.
