...
\useasboundingbox (-2.25, -3.40) rectangle (19.20, 10.00);
...
% ===== NODES =====
\node[global] (Mtrgb) at (0.65, 8.20) {$M_{\rm TRGB}$};
\node[global] (cstar) at (2.15, 8.20) {$c_\star$};
\node[global] (cpars) at (3.85, 8.20) {$(\bar c,\sigma_c)$};
\node[global, minimum width=1.15cm] (sigint) at (5.55, 8.20) {$\sigma_{\rm int}$};
\node[global] (H0) at (7.25, 8.20) {$H_0$};
\node[input] (rho) at (8.95, 8.20) {$\rho(\bm{r})$};
\node[input] (Vfield) at (10.65, 8.20) {$\bm{V}(\bm{r})$};
\node[global] (bias) at (12.35, 8.20) {$\bm{b}$};
\node[global] (pv) at (14.05, 8.20) {$\mathbf{V}_{\rm ext}$};
\node[global, minimum width=1.05cm] (sigv) at (15.75, 8.20) {$\sigma_v$};
\node[global] (selcuts) at (17.45, 8.20) {TRGB\\selection};
...
\node[sample, text width=2.15cm] (cdist) at (2.25, 3.15) {$c_i \sim$\\$\mathcal{N}(\bar c,\sigma_c^2)$};
...
\node[conditioned] (selected) at (14.70, -1.95) {$S_i=1$};
\node[selection] (detfrac) at (14.70, -3.05) {$p(S=1\mid\Lambda)$};
...
\draw[dag edge] (cpars.south) .. controls (4.15, 6.30) and (3.55, 4.10) .. (cdist.north east);
...
\draw[dag edge] (Mtrgb.south east) .. controls (2.10, 5.00) and (3.65, 1.10) .. (mtrue.north west);
\draw[dag edge] (cstar.south east) .. controls (3.00, 5.65) and (4.05, 1.35) .. (mtrue.north);
\draw[dag edge] (ctrue.south east) .. controls (3.25, 1.50) and (4.55, 0.95) .. (mtrue.north west);
\draw[dag edge] (mu) -- (mtrue);
\draw[dag edge] (mtrue) -- (msamp);
\draw[dag edge] (sigint.south) .. controls (5.55, 5.75) and (6.25, 0.10) .. ([xshift=1.05cm]msamp.north);
...
\draw[sel edge] (selcuts.south) .. controls (14.95, 5.05) and (14.70, -0.20) .. (selected.north);
\draw[sel edge] (mobs.south east) .. controls (7.20, -2.65) and (12.00, -2.65) .. (selected.south west);
\draw[sel edge] (selcuts.south east) .. controls (17.75, 5.05) and (17.20, -3.05) .. (detfrac.east);
\end{scope}
