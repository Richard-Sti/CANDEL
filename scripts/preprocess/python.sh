#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Tue  3 Mar 12:57:21 GMT 2026      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 10 --mpi=pmix --mem-per-cpu=32768 nice -n 10 /mnt/users/rstiskalek/CANDEL/venv_candel/bin/python compute_los.py --catalogue EDD_TRGB --reconstruction manticore_2MPP_MULTIBIN_N256_DES_V2 --config ../runs/config_EDD_TRGB.toml --smooth_target 0
  echo ---------------                                           
